...
<body>
                    ...
                    <AnonymousTemplate>
                        <ul>
                            <%--<a id="registerLink" runat="server" style="color: blue; font-size: medium; font-weight: 700;"
                               ...
                               <a id="A2" runat="server" style="color: blue; font-size: medium; font-weight: 700;"
                                href="~/help/help.htm">Help</a>
                            |
                            <a id="loginLink" runat="server" style="color: blue; font-size: medium; font-weight: 700;"
    ...
    <div id="editDialog" data-bind="with: cfidRecord">
            ...
            <select id="ISSUE_DESCRIPTION" data-bind="options: issueDescriptions, optionsCaption: '-Select a value-', value:ISSUE_DESCRIPTION"></select><br />  <h5>Collection Information</h5>
